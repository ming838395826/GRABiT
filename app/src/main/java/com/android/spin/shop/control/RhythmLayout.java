package com.android.spin.shop.control;
...
import com.android.spin.shop.utils.AnimatorUtils;
import com.android.spin.shop.utils.AppUtils;
...
public class RhythmLayout extends HorizontalScrollView {
	...
	private void init() {
		...
		mIntervalHeight = (mMaxTranslationHeight / 1);
		// 初始化
...
//										vibrate(10L);
	...
	private void updateItemHeightAnimator(View view, int translationY) {
		if (view != null)
			AnimatorUtils.showDown(view, translationY, 180, true,
					true);
	}
	...
	public Animator shootDownItem(View view, boolean isStart) {
		if (view != null)
			return AnimatorUtils.showDown(view,
	...
	public Animator bounceUpItem(View view, boolean isStart) {
		if (view != null)
			return AnimatorUtils.showEnlarge(view, 10, 350, isStart,
					true);
		return null;
	}
