package com.android.spin.shop.utils;
...
public class AnimatorUtils {
	 ...
	 * @return 平移动画
	 */
	public static Animator showEnlarge(View view, int translationY,
                                       int animatorTime, boolean isStartAnimator,
                                       boolean isStartInterpolator) {
...
//		return objectAnimator;
	 ...
	 * @return 平移动画
	 */
	public static Animator showDown(View view, int translationY,
                                    int animatorTime, boolean isStartAnimator,
                                    boolean isStartInterpolator) {
