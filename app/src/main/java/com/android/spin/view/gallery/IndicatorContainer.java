package com.android.spin.view.gallery;
...
public class IndicatorContainer extends LinearLayout implements IPagerIndicator {
  ...
  /** 标示符高亮的颜色 */
  private int mSelectedColor = getResources().getColor(R.color.app_font_color_main_title);
  /** 标示符非高亮的颜色 */
  private int mUnSelectedColor = getResources().getColor(R.color.color_white);
