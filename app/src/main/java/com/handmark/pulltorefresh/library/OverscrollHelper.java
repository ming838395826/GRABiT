...
public final class OverscrollHelper {
	...
	public static void overScrollBy(
			final com.handmark.pulltorefresh.library.PullToRefreshBase<?> view,
	...
	public static void overScrollBy(
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (com.handmark.pulltorefresh.library.PullToRefreshBase.DEBUG) {
				...
				if (newScrollValue < (0 - fuzzyThreshold)) {
					...
					&& PullToRefreshBase.State.OVERSCROLLING == view.getState()) {
