...
import com.ming.grabit.shop.fragment.CardViewPagerFragment;
...
public class HistoryFundDelegate extends MvpDelegate<IView, ShopPresenter> implements View.OnClickListener{
    @Bind(R.id.ttv_week)
    TTextView ttvWeek;
    @Bind(R.id.ttv_month)
    TTextView ttvMonth;
