...
import com.ming.grabit.logreg.adapter.HobbyListAdapter;
 ...
 */
public class FacebookRegisterStepFifthFragment extends BaseRegisterFragment implements View.OnClickListener {
    ...
    private UserEntity getUserEntity() {
        return ((FacebookBindPhoneActivity) getActivity()).getViewDelegate().getQuestEntity();
    }

    public FacebookRegisterStepFifthFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static FacebookRegisterStepFifthFragment newInstance() {
        FacebookRegisterStepFifthFragment fragment = new FacebookRegisterStepFifthFragment();
        return fragment;
    }
    ...
    private void checkParams() {
        ...
        params.put("birthday",getUserEntity().getBirthday());
        params.put("gender",getUserEntity().getGender());
        params.put("avatar", getUserEntity().getAvatar() + "");
