...
import com.ming.grabit.base.SpinApplication;
 ...
 * 描述：注册第三步
 */
public class RegisterStepThirdFragment extends BaseRegisterFragment
    ...
    public RegisterStepThirdFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static RegisterStepThirdFragment newInstance() {
        RegisterStepThirdFragment fragment = new RegisterStepThirdFragment();
        return fragment;
    }
    ...
    private String getPhone() {
        return ((RegisterActivity) getActivity()).getViewDelegate().getQuestEntity().getPhone();
    }
    ...
    private void checkParams() {
        ...
        RegisterQuestEntity entity = ((RegisterActivity) getActivity()).getViewDelegate()
                .getQuestEntity();
