 ...
 * 描述：注册第二步
 */
public class FacebookRegisterStepSecondFragment extends BaseRegisterFragment implements View.OnClickListener{
    ...
    public FacebookRegisterStepSecondFragment() {
    ...
    public static FacebookRegisterStepSecondFragment newInstance() {
        FacebookRegisterStepSecondFragment fragment = new FacebookRegisterStepSecondFragment();
        return fragment;
    }
    ...
    public void onSuccess(Object data, int type) {
        switch (type){
            case TYPE_PHONE_STATUS_REQUSE_CODE:
                ...
                ((FacebookBindPhoneActivity) getActivity()).getViewDelegate()
